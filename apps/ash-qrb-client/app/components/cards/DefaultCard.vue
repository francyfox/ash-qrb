...
<template>
  <div class="default-card flex max-w-[560px] max-w-screen-sm flex-col items-start gap-2.5 sm:rounded-[var(--Corner-Small,8px)] overflow-hidden [background:linear-gradient(180deg,var(--app-s-dark-vanilla,#DACBB1)_0%,var(--app-s-champagne,#F1EACE)_100%)] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)]">
    <div class="default-card-container flex flex-col items-center self-stretch">
